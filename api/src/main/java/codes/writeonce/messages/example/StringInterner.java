...
public final class StringInterner {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(StringInterner.class);

    private static final int SHIFT =
            Integer.getInteger("codes.writeonce.messages.example.StringInterner.table.size", 23);
